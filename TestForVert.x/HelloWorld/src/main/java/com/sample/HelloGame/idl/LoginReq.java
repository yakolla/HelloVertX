...
public class LoginReq implements org.apache.thrift.TBase<LoginReq, LoginReq._Fields>, java.io.Serializable, Cloneable, Comparable<LoginReq> {
  ...
  private static final org.apache.thrift.protocol.TField CAMP_FIELD_DESC = new org.apache.thrift.protocol.TField("camp", org.apache.thrift.protocol.TType.I32, (short)2);
  ...
  public LoginReq setHeader(ProtocolBase header) {
    this.header = header;
    return this;
  }
  ...
  public LoginReq setCamp(int camp) {
    this.camp = camp;
    setCampIsSet(true);
    return this;
  }
